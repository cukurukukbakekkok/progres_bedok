...
<div class="registration-wrapper">
    <div class="registration-container">
        ...
        <div class="step-indicator">
            <div class="step-item {{ $tahap_form ?? 0 >= 1 ? 'active' : '' }} {{ $tahap_form ?? 0 > 1 ? 'completed' : '' }}">
            ...
            <div class="step-item {{ $tahap_form ?? 0 >= 2 ? 'active' : '' }} {{ $tahap_form ?? 0 > 2 ? 'completed' : '' }}">
                <div class="step-circle">
                    @if(($tahap_form ?? 0) > 2)
                        <i class="fas fa-check"></i>
                    @else
            ...
            <div class="step-item {{ $tahap_form ?? 0 >= 3 ? 'active' : '' }}">
        ...
        <!-- Form -->
        <form id="multiStepForm" method="POST" action="{{ route('siswa.pendaftaran.store') }}" class="form-container">
            @csrf
            ...
            <div class="form-section active" id="tahap1">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nik" id="nik" class="form-control @error('nik') is-invalid @enderror" 
                           value="{{ old('nik', $data->nik ?? '') }}" maxlength="16" required>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="berat_badan" id="berat_badan" step="0.01" min="20" max="200" class="form-control @error('berat_badan') is-invalid @enderror" 
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="tinggi_badan" id="tinggi_badan" step="0.01" min="100" max="220" class="form-control @error('tinggi_badan') is-invalid @enderror" 
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="tel" name="no_wa" id="no_wa" class="form-control @error('no_wa') is-invalid @enderror" 
                ...
                <div class="form-group">
                    ...
                    <select name="jurusan" id="jurusan" class="form-control @error('jurusan') is-invalid @enderror" required onchange="updateRincianPembayaran()">
                        <option value="">-- Pilih Jurusan --</option>
                        <option value="RPL" {{ old('jurusan', $data->jurusan ?? '') == 'RPL' ? 'selected' : '' }}>
                            RPL (Rekayasa Perangkat Lunak)
                        </option>
                        <option value="TPM" {{ old('jurusan', $data->jurusan ?? '') == 'TPM' ? 'selected' : '' }}>
                            TPM (Teknik Pemesinan)
                        </option>
                        <option value="TITL" {{ old('jurusan', $data->jurusan ?? '') == 'TITL' ? 'selected' : '' }}>
                            TITL (Teknik Instalasi Tenaga Listrik)
                        </option>
                        <option value="TKR" {{ old('jurusan', $data->jurusan ?? '') == 'TKR' ? 'selected' : '' }}>
            ...
            <div class="form-section" id="tahap2">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="kode_pos" id="kode_pos" class="form-control @error('kode_pos') is-invalid @enderror" 
                                   value="{{ old('kode_pos', $data->kode_pos ?? '') }}" maxlength="5" required>
                            @error('kode_pos')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="rt_rw" id="rt_rw" class="form-control @error('rt_rw') is-invalid @enderror" 
                                   value="{{ old('rt_rw', $data->rt_rw ?? '') }}" placeholder="Contoh: 001/002">
                ...
                <div class="form-group">
                    ...
                    <textarea name="alamat" id="alamat" class="form-control @error('alamat') is-invalid @enderror" required>{{ old('alamat', $data->alamat ?? '') }}</textarea>
            ...
            <div class="form-section" id="tahap3">
                ...
                <div class="form-group">
                    ...
                    <select name="status_keluarga" id="status_keluarga" class="form-control @error('status_keluarga') is-invalid @enderror" required onchange="toggleFamilyFields()">
                        <option value="">-- Pilih Status --</option>
                        <option value="ayah_ibu" {{ old('status_keluarga', $data->status_keluarga ?? '') == 'ayah_ibu' ? 'selected' : '' }}>
                            Orang Tua Lengkap (Ayah & Ibu)
                        </option>
                        <option value="yatim" {{ old('status_keluarga', $data->status_keluarga ?? '') == 'yatim' ? 'selected' : '' }}>
                            Yatim (Ayah Meninggal) - Ada Wali
                        </option>
                        <option value="piatu" {{ old('status_keluarga', $data->status_keluarga ?? '') == 'piatu' ? 'selected' : '' }}>
                            Piatu (Ibu Meninggal) - Ada Wali
                        </option>
                        <option value="yatim_piatu" {{ old('status_keluarga', $data->status_keluarga ?? '') == 'yatim_piatu' ? 'selected' : '' }}>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="tempat_lahir_ayah" id="tempat_lahir_ayah" class="form-control @error('tempat_lahir_ayah') is-invalid @enderror" 
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" name="tanggal_lahir_ayah" id="tanggal_lahir_ayah" class="form-control @error('tanggal_lahir_ayah') is-invalid @enderror" 
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="pendidikan_ayah" id="pendidikan_ayah" class="form-control @error('pendidikan_ayah') is-invalid @enderror">
                                    ...
                                    <option value="SMA/SMK" {{ old('pendidikan_ayah', $data->pendidikan_ayah ?? '') == 'SMA/SMK' ? 'selected' : '' }}>SMA/SMK</option>
                                    ...
                                    <option value="Pasca Sarjana" {{ old('pendidikan_ayah', $data->pendidikan_ayah ?? '') == 'Pasca Sarjana' ? 'selected' : '' }}>Pasca Sarjana</option>
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="penghasilan_ayah" id="penghasilan_ayah" class="form-control @error('penghasilan_ayah') is-invalid @enderror">
                                    ...
                                    <option value="Kurang dari Rp 1.000.000" {{ old('penghasilan_ayah', $data->penghasilan_ayah ?? '') == 'Kurang dari Rp 1.000.000' ? 'selected' : '' }}>Kurang dari Rp 1.000.000</option>
                                    <option value="Rp 1.000.000 - Rp 2.500.000" {{ old('penghasilan_ayah', $data->penghasilan_ayah ?? '') == 'Rp 1.000.000 - Rp 2.500.000' ? 'selected' : '' }}>Rp 1.000.000 - Rp 2.500.000</option>
                                    <option value="Rp 2.500.000 - Rp 5.000.000" {{ old('penghasilan_ayah', $data->penghasilan_ayah ?? '') == 'Rp 2.500.000 - Rp 5.000.000' ? 'selected' : '' }}>Rp 2.500.000 - Rp 5.000.000</option>
                                    <option value="Rp 5.000.000 - Rp 10.000.000" {{ old('penghasilan_ayah', $data->penghasilan_ayah ?? '') == 'Rp 5.000.000 - Rp 10.000.000' ? 'selected' : '' }}>Rp 5.000.000 - Rp 10.000.000</option>
                                    <option value="Lebih dari Rp 10.000.000" {{ old('penghasilan_ayah', $data->penghasilan_ayah ?? '') == 'Lebih dari Rp 10.000.000' ? 'selected' : '' }}>Lebih dari Rp 10.000.000</option>
                                </select>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="tel" name="no_hp_ayah" id="no_hp_ayah" class="form-control @error('no_hp_ayah') is-invalid @enderror" 
                                       value="{{ old('no_hp_ayah', $data->no_hp_ayah ?? '') }}">
                                @error('no_hp_ayah')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="tempat_lahir_ibu" id="tempat_lahir_ibu" class="form-control @error('tempat_lahir_ibu') is-invalid @enderror" 
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" name="tanggal_lahir_ibu" id="tanggal_lahir_ibu" class="form-control @error('tanggal_lahir_ibu') is-invalid @enderror" 
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="pendidikan_ibu" id="pendidikan_ibu" class="form-control @error('pendidikan_ibu') is-invalid @enderror">
                                    ...
                                    <option value="SMA/SMK" {{ old('pendidikan_ibu', $data->pendidikan_ibu ?? '') == 'SMA/SMK' ? 'selected' : '' }}>SMA/SMK</option>
                                    ...
                                    <option value="Pasca Sarjana" {{ old('pendidikan_ibu', $data->pendidikan_ibu ?? '') == 'Pasca Sarjana' ? 'selected' : '' }}>Pasca Sarjana</option>
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="penghasilan_ibu" id="penghasilan_ibu" class="form-control @error('penghasilan_ibu') is-invalid @enderror">
                                    <option value="">-- Pilih Rentang Penghasilan --</option>
                                    <option value="Kurang dari Rp 1.000.000" {{ old('penghasilan_ibu', $data->penghasilan_ibu ?? '') == 'Kurang dari Rp 1.000.000' ? 'selected' : '' }}>Kurang dari Rp 1.000.000</option>
                                    <option value="Rp 1.000.000 - Rp 2.500.000" {{ old('penghasilan_ibu', $data->penghasilan_ibu ?? '') == 'Rp 1.000.000 - Rp 2.500.000' ? 'selected' : '' }}>Rp 1.000.000 - Rp 2.500.000</option>
                                    <option value="Rp 2.500.000 - Rp 5.000.000" {{ old('penghasilan_ibu', $data->penghasilan_ibu ?? '') == 'Rp 2.500.000 - Rp 5.000.000' ? 'selected' : '' }}>Rp 2.500.000 - Rp 5.000.000</option>
                                    <option value="Rp 5.000.000 - Rp 10.000.000" {{ old('penghasilan_ibu', $data->penghasilan_ibu ?? '') == 'Rp 5.000.000 - Rp 10.000.000' ? 'selected' : '' }}>Rp 5.000.000 - Rp 10.000.000</option>
                                    <option value="Lebih dari Rp 10.000.000" {{ old('penghasilan_ibu', $data->penghasilan_ibu ?? '') == 'Lebih dari Rp 10.000.000' ? 'selected' : '' }}>Lebih dari Rp 10.000.000</option>
                                </select>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="tel" name="no_hp_ibu" id="no_hp_ibu" class="form-control @error('no_hp_ibu') is-invalid @enderror" 
                                       value="{{ old('no_hp_ibu', $data->no_hp_ibu ?? '') }}">
                                @error('no_hp_ibu')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                ...
                <div id="waliSection" class="conditional-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="tempat_lahir_wali" id="tempat_lahir_wali" class="form-control @error('tempat_lahir_wali') is-invalid @enderror" 
                                       value="{{ old('tempat_lahir_wali', $data->tempat_lahir_wali ?? '') }}">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" name="tanggal_lahir_wali" id="tanggal_lahir_wali" class="form-control @error('tanggal_lahir_wali') is-invalid @enderror" 
                                       value="{{ old('tanggal_lahir_wali', $data->tanggal_lahir_wali ?? '') }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="pendidikan_wali" id="pendidikan_wali" class="form-control @error('pendidikan_wali') is-invalid @enderror">
                                    ...
                                    <option value="Tidak Sekolah" {{ old('pendidikan_wali', $data->pendidikan_wali ?? '') == 'Tidak Sekolah' ? 'selected' : '' }}>Tidak Sekolah</option>
                                    <option value="SD" {{ old('pendidikan_wali', $data->pendidikan_wali ?? '') == 'SD' ? 'selected' : '' }}>SD</option>
                                    <option value="SMP" {{ old('pendidikan_wali', $data->pendidikan_wali ?? '') == 'SMP' ? 'selected' : '' }}>SMP</option>
                                    <option value="SMA/SMK" {{ old('pendidikan_wali', $data->pendidikan_wali ?? '') == 'SMA/SMK' ? 'selected' : '' }}>SMA/SMK</option>
                                    <option value="Diploma" {{ old('pendidikan_wali', $data->pendidikan_wali ?? '') == 'Diploma' ? 'selected' : '' }}>Diploma</option>
                                    <option value="Sarjana" {{ old('pendidikan_wali', $data->pendidikan_wali ?? '') == 'Sarjana' ? 'selected' : '' }}>Sarjana</option>
                                    <option value="Magister" {{ old('pendidikan_wali', $data->pendidikan_wali ?? '') == 'Magister' ? 'selected' : '' }}>Magister</option>
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="penghasilan_wali" id="penghasilan_wali" class="form-control @error('penghasilan_wali') is-invalid @enderror">
                                    <option value="">-- Pilih Rentang Penghasilan --</option>
                                    <option value="Kurang dari Rp 1.000.000" {{ old('penghasilan_wali', $data->penghasilan_wali ?? '') == 'Kurang dari Rp 1.000.000' ? 'selected' : '' }}>Kurang dari Rp 1.000.000</option>
                                    <option value="Rp 1.000.000 - Rp 2.500.000" {{ old('penghasilan_wali', $data->penghasilan_wali ?? '') == 'Rp 1.000.000 - Rp 2.500.000' ? 'selected' : '' }}>Rp 1.000.000 - Rp 2.500.000</option>
                                    <option value="Rp 2.500.000 - Rp 5.000.000" {{ old('penghasilan_wali', $data->penghasilan_wali ?? '') == 'Rp 2.500.000 - Rp 5.000.000' ? 'selected' : '' }}>Rp 2.500.000 - Rp 5.000.000</option>
                                    <option value="Rp 5.000.000 - Rp 10.000.000" {{ old('penghasilan_wali', $data->penghasilan_wali ?? '') == 'Rp 5.000.000 - Rp 10.000.000' ? 'selected' : '' }}>Rp 5.000.000 - Rp 10.000.000</option>
                                    <option value="Lebih dari Rp 10.000.000" {{ old('penghasilan_wali', $data->penghasilan_wali ?? '') == 'Lebih dari Rp 10.000.000' ? 'selected' : '' }}>Lebih dari Rp 10.000.000</option>
                                </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" name="no_hp_wali" id="no_hp_wali" class="form-control @error('no_hp_wali') is-invalid @enderror" 
