        ...
        <div class="confirmation-content">
            ...
            <div class="data-grid">
                <div class="data-item">
                    ...
                    <div class="data-value">{{ $calon->nama_lengkap }}</div>
                </div>
                <div class="data-item">
                    <div class="data-label">NISN</div>
                    <div class="data-value">{{ $calon->nisn }}</div>
                </div>
                <div class="data-item">
                    <div class="data-label">NIK</div>
                    <div class="data-value">{{ $calon->nik }}</div>
                </div>
                <div class="data-item">
                    <div class="data-label">Jenis Kelamin</div>
                    <div class="data-value">{{ $calon->jenis_kelamin }}</div>
                </div>
                <div class="data-item">
                    <div class="data-label">Tempat Lahir</div>
                    <div class="data-value">{{ $calon->tempat_lahir }}</div>
                </div>
                <div class="data-item">
                    <div class="data-label">Tanggal Lahir</div>
                    <div class="data-value">{{ \Carbon\Carbon::parse($calon->tanggal_lahir)->format('d/m/Y') }}</div>
                </div>
                <div class="data-item">
                    <div class="data-label">Agama</div>
                    <div class="data-value">{{ $calon->agama }}</div>
                </div>
                <div class="data-item">
                    <div class="data-label">Asal Sekolah</div>
                    <div class="data-value">{{ $calon->asal_sekolah }}</div>
                </div>
                <div class="data-item">
                    <div class="data-label">Jurusan Pilihan</div>
                    <div class="data-value">{{ $calon->jurusan }}</div>
                </div>
                <div class="data-item">
                    <div class="data-label">Berat Badan</div>
                    <div class="data-value">{{ $calon->berat_badan }} kg</div>
                </div>
                <div class="data-item">
                    <div class="data-label">Tinggi Badan</div>
                    <div class="data-value">{{ $calon->tinggi_badan }} cm</div>
                </div>
                <div class="data-item">
                    <div class="data-label">No. HP</div>
                    <div class="data-value">{{ $calon->no_hp }}</div>
                </div>
                <div class="data-item">
                    <div class="data-label">No. WhatsApp</div>
                    <div class="data-value">{{ $calon->no_wa }}</div>
                </div>
            </div>
            ...
            <div class="data-grid">
                <div class="data-item" style="grid-column: 1/-1;">
                    ...
                    <div class="data-value">{{ $calon->alamat }}</div>
                </div>
                <div class="data-item">
                    <div class="data-label">Provinsi</div>
                    <div class="data-value">{{ $calon->provinsi }}</div>
                </div>
                <div class="data-item">
                    <div class="data-label">Kabupaten</div>
                    <div class="data-value">{{ $calon->kabupaten }}</div>
                </div>
                <div class="data-item">
                    <div class="data-label">Kecamatan</div>
                    <div class="data-value">{{ $calon->kecamatan }}</div>
                </div>
                <div class="data-item">
                    <div class="data-label">Kelurahan</div>
                    <div class="data-value">{{ $calon->kelurahan }}</div>
                </div>
                <div class="data-item">
                    <div class="data-label">Kode Pos</div>
                    <div class="data-value">{{ $calon->kode_pos }}</div>
                </div>
                <div class="data-item">
                    <div class="data-label">RT/RW</div>
                    <div class="data-value">{{ $calon->rt_rw ?? '-' }}</div>
                </div>
            </div>
                ...
                <div style="margin-bottom: 30px;">
                    ...
                    <div class="data-grid">
                        <div class="data-item">
                            ...
                            <div class="data-value">{{ $calon->nama_ayah ?? '-' }}</div>
                        </div>
                        <div class="data-item">
                            <div class="data-label">Tempat Lahir</div>
                            <div class="data-value">{{ $calon->tempat_lahir_ayah ?? '-' }}</div>
                        </div>
                        <div class="data-item">
                            <div class="data-label">Tanggal Lahir</div>
                            <div class="data-value">{{ $calon->tanggal_lahir_ayah ? \Carbon\Carbon::parse($calon->tanggal_lahir_ayah)->format('d/m/Y') : '-' }}</div>
                        </div>
                        <div class="data-item">
                            <div class="data-label">Pendidikan</div>
                            <div class="data-value">{{ $calon->pendidikan_ayah ?? '-' }}</div>
                        </div>
                        <div class="data-item">
                            <div class="data-label">Pekerjaan</div>
                            <div class="data-value">{{ $calon->pekerjaan_ayah ?? '-' }}</div>
                        </div>
                        <div class="data-item">
                            <div class="data-label">Penghasilan</div>
                            <div class="data-value">{{ $calon->penghasilan_ayah ?? '-' }}</div>
                        </div>
                        <div class="data-item">
                            <div class="data-label">No. HP</div>
                            <div class="data-value">{{ $calon->no_hp_ayah ?? '-' }}</div>
                        </div>
                    </div>
                </div>
                ...
                <div style="margin-bottom: 30px;">
                    ...
                    <div class="data-grid">
                        <div class="data-item">
                            ...
                            <div class="data-value">{{ $calon->nama_ibu ?? '-' }}</div>
                        </div>
                        <div class="data-item">
                            <div class="data-label">Tempat Lahir</div>
                            <div class="data-value">{{ $calon->tempat_lahir_ibu ?? '-' }}</div>
                        </div>
                        <div class="data-item">
                            <div class="data-label">Tanggal Lahir</div>
                            <div class="data-value">{{ $calon->tanggal_lahir_ibu ? \Carbon\Carbon::parse($calon->tanggal_lahir_ibu)->format('d/m/Y') : '-' }}</div>
                        </div>
                        <div class="data-item">
                            <div class="data-label">Pendidikan</div>
                            <div class="data-value">{{ $calon->pendidikan_ibu ?? '-' }}</div>
                        </div>
                        <div class="data-item">
                            <div class="data-label">Pekerjaan</div>
                            <div class="data-value">{{ $calon->pekerjaan_ibu ?? '-' }}</div>
                        </div>
                        <div class="data-item">
                            <div class="data-label">Penghasilan</div>
                            <div class="data-value">{{ $calon->penghasilan_ibu ?? '-' }}</div>
                        </div>
                        <div class="data-item">
                            <div class="data-label">No. HP</div>
                            <div class="data-value">{{ $calon->no_hp_ibu ?? '-' }}</div>
                        </div>
                    </div>
                </div>
            @else
                <div class="data-grid">
                    <div class="data-item">
                        ...
                        <div class="data-value">{{ $calon->nama_wali ?? '-' }}</div>
                    </div>
                    <div class="data-item">
                        <div class="data-label">Tempat Lahir</div>
                        <div class="data-value">{{ $calon->tempat_lahir_wali ?? '-' }}</div>
                    </div>
                    <div class="data-item">
                        <div class="data-label">Tanggal Lahir</div>
                        <div class="data-value">{{ $calon->tanggal_lahir_wali ? \Carbon\Carbon::parse($calon->tanggal_lahir_wali)->format('d/m/Y') : '-' }}</div>
                    </div>
                    <div class="data-item">
                        <div class="data-label">Pendidikan</div>
                        <div class="data-value">{{ $calon->pendidikan_wali ?? '-' }}</div>
                    </div>
                    <div class="data-item">
                        <div class="data-label">Pekerjaan</div>
                        <div class="data-value">{{ $calon->pekerjaan_wali ?? '-' }}</div>
                    </div>
                    <div class="data-item">
                        <div class="data-label">Penghasilan</div>
                        <div class="data-value">{{ $calon->penghasilan_wali ?? '-' }}</div>
                    </div>
                    <div class="data-item">
                        <div class="data-label">No. HP</div>
                        <div class="data-value">{{ $calon->no_hp_wali ?? '-' }}</div>
                    </div>
                </div>
            @endif
            ...
            @if($dokumen)
                <div class="data-grid" style="grid-template-columns: repeat(auto-fit, minmax(300px, 1fr));">
                    @foreach(['akte_kelahiran' => 'Akte Kelahiran', 'ijazah_smp' => 'Ijazah SMP', 'skl_smp' => 'SKL SMP', 'kartu_keluarga' => 'Kartu Keluarga', 'ktp_ortu' => 'KTP Orang Tua'] as $field => $label)
                        @if($dokumen->$field)
                            @php
                                ...
                                <div class="data-value mt-2">
                                    @if($isImage)
                                        <div style="border-radius: 8px; overflow: hidden; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
                                            <img src="{{ asset('storage/' . $dokumen->$field) }}" alt="{{ $label }}" style="width: 100%; height: auto; display: block;">
                                        </div>
                                    @else
                                        <div class="p-3 bg-light text-center rounded border">
                                            <i class="fas fa-file-pdf fa-3x text-danger mb-2"></i>
                                            <p class="mb-0 small text-muted">Format: {{ strtoupper($ext) }}</p>
                                        </div>
                                    @endif
                                    
                                    <a href="{{ asset('storage/' . $dokumen->$field) }}" target="_blank" class="btn btn-sm btn-outline-primary mt-3 w-100">
                        ...
                        @else
                            <div class="data-item" style="background: #fff3cd; border-left-color: #ffc107;">
                                <div class="data-label"><i class="fas fa-exclamation-triangle" style="color: #ffc107; margin-right: 5px;"></i> {{ $label }}</div>
            ...
            <div class="data-grid">
                <div class="data-item" style="grid-column: 1/-1; background: #f0f7ff; border-left-color: var(--primary);">
                    ...
                    <div class="data-value" style="font-size: 20px;">{{ $calon->jurusan }}</div>
                </div>
                <div class="data-item" style="grid-column: 1/-1; background: #e8f5e9; border-left-color: var(--success);">
                    ...
                    <div class="data-value" style="font-size: 20px; color: var(--success); font-weight: bold;">
                        Rp {{ number_format($calon->nominal_pembayaran, 0, ',', '.') }}
                    </div>
                </div>
            </div>
            ...
            <div class="action-buttons" style="display: flex; flex-direction: column; gap: 15px; align-items: center; margin-top: 30px;">
                ...
                @if(!$isLocked)
                    @if(!$calon->data_confirmed)
                        {{-- Belum dikonfirmasi: tampilkan Ubah Data & Konfirmasi sejajar --}}
                        <div style="display: flex; gap: 15px; justify-content: center; flex-wrap: wrap;">
                            <a href="{{ route('siswa.pendaftaran.edit', $calon->id) }}" class="btn" style="background: #f0f0f0; color: #333; padding: 12px 25px; border-radius: 8px; text-decoration: none; font-weight: 600;">
                                <i class="fas fa-user-edit"></i> Ubah Biodata
                            </a>
                            <a href="{{ route('siswa.dokumen.index') }}" class="btn" style="background: #f0f0f0; color: #333; padding: 12px 25px; border-radius: 8px; text-decoration: none; font-weight: 600;">
                                <i class="fas fa-file-alt"></i> Ubah Dokumen
                            </a>
                            <form action="{{ route('siswa.pendaftaran.confirm', $calon->id) }}" method="POST" style="display: inline;">
                                @csrf
                    ...
                    @else
                        {{-- Sudah dikonfirmasi tapi belum terkunci: bisa edit --}}
                        ...
                        <div style="display: flex; gap: 15px; justify-content: center; flex-wrap: wrap;">
                            ...
                            <a href="{{ route('siswa.dashboard') }}" class="btn" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 12px 25px; border-radius: 8px; text-decoration: none; font-weight: 600;">
