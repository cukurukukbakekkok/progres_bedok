...
<div class="biodata-wrapper">
    <div class="biodata-container">
        ...
        @if ($siswa)
            <!-- Status Alert -->
            <div class="status-alert {{ strtolower(str_replace(' ', '-', $siswa->status_kelulusan ?? 'menunggu')) }} animate__animated animate__slideInDown" style="animation-delay: 0.2s;">
                <h3>
            ...
            <div class="biodata-card animate__animated animate__slideInUp" style="animation-delay: 0.3s;">
                ...
                <div class="biodata-section">
                    ...
                    <div class="biodata-row">
                        ...
                        <div class="biodata-value">
                            <span class="badge-code">{{ $siswa->kode_pendaftaran ?? '-' }}</span>
                        </div>
                    </div>
                    ...
                    <div class="biodata-row">
                        ...
                        <div class="biodata-value">
                            <span class="badge-gelombang">{{ $siswa->gelombang->nama ?? '-' }}</span>
                        </div>
                    </div>
                    ...
                    <div class="biodata-row">
                        ...
                        <div class="biodata-value">
                            <span class="badge-jurusan">{{ $siswa->jurusan ?? '-' }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="biodata-section">
                    ...
                    <div class="biodata-row">
                        ...
                        <div class="biodata-value">{{ $siswa->nisn }}</div>
                    </div>

                    <div class="biodata-row">
                        <div class="biodata-label">Tempat Lahir</div>
                        <div class="biodata-value">{{ $siswa->tempat_lahir }}</div>
                    </div>
                    ...
                    <div class="biodata-row">
                        ...
                        <div class="biodata-value">
                            {{ $siswa->jenis_kelamin == 'Laki-laki' ? '🧑 Laki-laki' : '👩 Perempuan' }}
                        </div>
                    </div>

                    <div class="biodata-row">
                        <div class="biodata-label">Asal Sekolah</div>
                        <div class="biodata-value">{{ $siswa->asal_sekolah }}</div>
                    </div>
                </div>
                ...
                <div class="biodata-section">
                    ...
                    <div class="biodata-row">
                        ...
                        <div class="biodata-value">{{ $siswa->nama_orang_tua }}</div>
                    </div>

                    <div class="biodata-row">
                        <div class="biodata-label">Nomor HP</div>
                        <div class="biodata-value">
                            <a href="tel:{{ $siswa->no_hp }}" style="color: #667eea; text-decoration: none; font-weight: 600;">
                                {{ $siswa->no_hp }}
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="biodata-row">
                        ...
                        <div class="biodata-value" style="white-space: pre-wrap;">{{ $siswa->alamat }}</div>
                    </div>
                </div>

                <!-- Action Buttons -->
                <div class="action-buttons">
                    <a href="{{ route('siswa.dashboard') }}" class="btn-action btn-secondary-action">
                        ← Kembali ke Dashboard
                    </a>
                    <a href="{{ route('siswa.dokumen.index') }}" class="btn-action btn-primary-action">
                        Lihat Dokumen →
                    </a>
                </div>
            </div>
