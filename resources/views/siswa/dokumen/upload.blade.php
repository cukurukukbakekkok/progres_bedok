        ...
        <div class="upload-container">
            ...
            @if($dokumen)
                ...
                <div class="form-card animate__animated animate__slideInUp" style="animation-delay: 0.3s;">
                    <form id="dokumen-form" action="{{ route('siswa.dokumen.store') }}" method="POST"
                        ...
                        <div class="document-item">
                            ...
                            <div id="foto_upload" style="display: {{ $dokumen->foto ? 'none !important' : 'block' }};">
                            ...
                            @if($dokumen->foto)
                                <div class="file-info" style="display: block;">
                                    <span class="file-name">✓ {{ basename($dokumen->foto) }}</span>
                                    <div>
                                        <a href="{{ asset('storage/' . $dokumen->foto) }}" target="_blank" class="view-btn">
                                            👁️ Lihat
                                        </a>
                                        @if($dokumen->status_verifikasi !== 'Valid')
                        ...
                        <div class="document-item">
                            ...
                            <div id="akte_kelahiran_upload"
                                style="display: {{ $dokumen->akte_kelahiran ? 'none !important' : 'block' }};">
                                <label class="file-input-label">
                                    📁 Pilih File
                            ...
                            @if($dokumen->akte_kelahiran)
                                <div class="file-info" style="display: block;">
                                    ...
                                    <div>
                                        <a href="{{ asset('storage/' . $dokumen->akte_kelahiran) }}" target="_blank"
                                            class="view-btn">
                                            👁️ Lihat
                                        </a>
                                        @if($dokumen->status_verifikasi !== 'Valid')
                        ...
                        <div class="document-item">
                            ...
                            <div id="ijazah_smp_upload"
                                style="display: {{ $dokumen->ijazah_smp ? 'none !important' : 'block' }};">
                                <label class="file-input-label">
                                    📁 Pilih File
                        ...
                        <div class="document-item">
                            ...
                            <div id="kartu_keluarga_upload"
                                style="display: {{ $dokumen->kartu_keluarga ? 'none !important' : 'block' }};">
                                <label class="file-input-label">
                                    📁 Pilih File
                            ...
                            @if($dokumen->kartu_keluarga)
                                <div class="file-info" style="display: block;">
                                    ...
                                    <div>
                                        <a href="{{ asset('storage/' . $dokumen->kartu_keluarga) }}" target="_blank"
                                            class="view-btn">
                                            👁️ Lihat
                                        </a>
                                        @if($dokumen->status_verifikasi !== 'Valid')
