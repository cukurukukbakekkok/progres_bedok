                ...
                <div class="card-body p-5">
                    ...
                    <form action="{{ route('admin.promo.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="kode_promo" id="kode_promo" class="form-control form-control-lg text-uppercase font-monospace @error('kode_promo') is-invalid @enderror" placeholder="Cth: DISKON50" value="{{ old('kode_promo') }}" required>
                            @error('kode_promo')
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="diskon_nominal" id="diskon_nominal" class="form-control form-control-lg @error('diskon_nominal') is-invalid @enderror" placeholder="50000" value="{{ old('diskon_nominal') }}" required>
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="id_gelombang" id="id_gelombang" class="form-select @error('id_gelombang') is-invalid @enderror">
                                ...
                                @foreach($gelombang as $g)
                                    <option value="{{ $g->id }}" {{ old('id_gelombang') == $g->id ? 'selected' : '' }}>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="date" name="tanggal_mulai" id="tanggal_mulai" class="form-control @error('tanggal_mulai') is-invalid @enderror" value="{{ old('tanggal_mulai') }}" min="{{ date('Y-m-d') }}">
                                @error('tanggal_mulai')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="date" name="tanggal_selesai" id="tanggal_selesai" class="form-control @error('tanggal_selesai') is-invalid @enderror" value="{{ old('tanggal_selesai') }}" min="{{ date('Y-m-d') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="max_usage" id="max_usage" class="form-control @error('max_usage') is-invalid @enderror" placeholder="0 = Tak Terbatas" value="{{ old('max_usage') }}">
                            @error('max_usage')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
