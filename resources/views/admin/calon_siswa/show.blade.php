    ...
    <div class="card shadow-lg border-0 animate__animated animate__fadeIn">
        <div class="card-body">
            ...
            <div class="alert alert-success border-0 shadow-sm d-flex align-items-center justify-content-between p-4">
                ...
                <a href="{{ route('admin.calon_siswa.preview_bukti', $siswa->id) }}" class="btn btn-primary fw-bold px-4 py-2 rounded-pill shadow-sm">
                    <i class="ti ti-mail-forward me-1"></i> {{ $siswa->is_bukti_dikirim ? 'LIHAT / KIRIM ULANG' : 'KIRIM BUKTI PENERIMAAN' }}
                </a>
            </div>
            @endif
