    ...
    <div class="container">
        ...
        @if($pengumuman->count() > 0)
            <div class="pengumuman-grid">
                ...
                <a href="{{ route('pengumuman.public.show', $item->id) }}" class="pengumuman-card">
                    <div class="card-top-border"></div>
                    <div class="card-body">
                        <span class="card-date">{{ $item->tanggal_post->format('d M Y') }}</span>
                        <h3 class="card-title">{{ $item->judul }}</h3>
                        <p class="card-excerpt">{{ Str::limit($item->isi, 150, '...') }}</p>
        ...
        @else
            <div class="empty-state">
                ...
                <a href="{{ route('welcome') }}" class="btn-gradient-primary">Kembali ke Beranda</a>
            </div>
        @endif
    </div>
</div>
