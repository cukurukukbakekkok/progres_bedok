    ...
    <body>
        ...
        <div class="auth-main">
            <div class="auth-wrapper v3">
                ...
                <div class="auth-form"
                    style="background-image: url(<?php echo e(asset('assets/images/my/antartika-img.jpeg')); ?>); background-size: cover; background-position: center;">
                    <div class="auth-header">
                        <a class="navbar-brand" href="/">
                            <!-- ganti logo sesuai landing -->
                            <img width="100" src="<?php echo e(asset('assets/images/my/logo-antrek.png')); ?>" alt="logo">
                        </a>
                    </div>
...
<?php /**PATH C:\BEDOK_UKK_PPDB2\resources\views/layouts/auth.blade.php ENDPATH**/ ?>