        ...
        <div class="form-card" style="position: relative;">
            ...
            <div class="code-card animate__animated animate__fadeInUp">
                <div class="code-card-content">
                    ...
                    <div class="code-display"><?php echo e($kodePendaftaranPreview); ?></div>
                    <div class="code-hint">💾 Simpan kode ini untuk referensi dan tracking pendaftaran Anda</div>
                </div>
            </div>

            <!-- Main Form -->
            <form action="<?php echo e(route('siswa.pendaftaran.store')); ?>" method="POST" class="space-y-5">
                <?php echo csrf_field(); ?>
                        ...
                        <?php $__currentLoopData = $gelombang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($g->status == 'aktif'): ?>
                                ...
                                <option value="<?php echo e($g->id); ?>" 
                                        data-kuota="<?php echo e($g->kuota); ?>" 
                                        data-terdaftar="<?php echo e($jumlahSiswa); ?>"
                                        data-sisa="<?php echo e($sisaKuota); ?>"
                                        data-potongan="<?php echo e($g->potongan ?? 0); ?>"
                                        data-keterangan-potongan="<?php echo e($g->keterangan_potongan ?? ''); ?>"
                                        data-deskripsi="<?php echo e($g->deskripsi ?? ''); ?>">
                                    <?php echo e($g->nama); ?> (<?php echo e($mulai); ?> - <?php echo e($selesai); ?>)
                                </option>
                            <?php endif; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
...
$message = $__bag->first($__errorArgs[0]); ?>
                        <div class="form-hint" style="color: #dc3545;"><?php echo e($message); ?></div>
                    <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-row animate__animated animate__fadeInUp" style="animation-delay: 0.4s;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="tanggal_lahir" required min="1950-01-01" max="<?php echo e(date('Y-m-d')); ?>">
                    </div>
                </div>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\BEDOK_UKK_PPDB2\resources\views/siswa/pendaftaran/create.blade.php ENDPATH**/ ?>