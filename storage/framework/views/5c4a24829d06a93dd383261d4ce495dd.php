        ...
        <div class="card border-0 shadow-lg" style="border-radius: 20px; overflow: hidden; backdrop-filter: blur(10px);">
            ...
            <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 50px 30px; text-align: center; position: relative; overflow: hidden;">
                ...
                <div style="position: relative; z-index: 2;">
                    ...
                    <h2 class="text-white mb-2" style="font-weight: 700; margin: 0; letter-spacing: -0.5px;">Selamat Datang!</h2>
                    <p class="text-white" style="margin: 0; opacity: 0.9; font-size: 14px; font-weight: 300;">Masuk ke akun PPDB Anda dan mulai perjalanan pendaftaran</p>
                </div>
            </div>
            ...
            <form method="POST" action="<?php echo e(route('login.post')); ?>">
                ...
                <div style="padding: 40px 30px;">
                    ...
                    <div style="margin-bottom: 20px;">
                        <label for="password" style="display: block; font-weight: 600; margin-bottom: 10px; color: #333; font-size: 14px;">Password</label>
                        <div style="display: flex; border-radius: 12px; overflow: hidden; border: 2px solid #e0e0e0; transition: all 0.3s ease; background: #f8f9fa;">
                            <span style="background: transparent; border: none; padding: 14px 16px; color: #667eea; font-size: 18px;">
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 30px;">
                        <div style="display: flex; align-items: center;">
                            <input class="form-check-input" type="checkbox" id="customCheckc1" name="remember" style="margin-right: 8px; width: 18px; height: 18px; cursor: pointer;">
                            <label class="form-check-label" for="customCheckc1" style="color: #666; font-weight: 500; margin: 0; cursor: pointer; font-size: 14px;">
                                Ingat saya
                            </label>
                        </div>
                        <a href="<?php echo e(route('password.request')); ?>" style="color: #667eea; font-weight: 600; text-decoration: none; font-size: 14px; transition: all 0.3s ease;"
                    ...
                    <!-- Register Link -->
                    <div>
                        <a href="/register" style="width: 100%; display: block; text-align: center; background: rgba(102, 126, 234, 0.08); color: #667eea; border-radius: 12px; border: 2px solid rgba(102, 126, 234, 0.2); padding: 14px 20px; font-weight: 600; transition: all 0.3s ease; cursor: pointer; text-decoration: none; box-sizing: border-box; font-size: 15px;"
