                            ...
                            <div class="modal-body">
                                <div id="announcementsCarousel" class="carousel slide" data-bs-ride="carousel">
                                    <div class="carousel-inner">
                                        <?php $__currentLoopData = $announcements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="carousel-item <?php echo e($i==0 ? 'active' : ''); ?>">
                                            <h4><?php echo e($a->judul); ?></h4>
                                            <p class="text-muted"><?php echo e(\Carbon\Carbon::parse($a->tanggal_post)->format('d M Y')); ?></p>
                                            <div class="mt-3"><?php echo nl2br(e($a->isi)); ?></div>
                                        </div>
        ...
        <nav class="navbar navbar-expand-md navbar-dark default py-0">
            <div class="container">
                <a class="navbar-brand d-flex align-items-center" href="/">
                    <img class="brand-logo" width="70" src="<?php echo e(asset('assets/images/my/logo-antrek.png')); ?>" alt="logo antrek">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <?php if(auth()->check()): ?>
                            <li class="nav-item">
                                <a class="btn btn-primary" href="/dashboard"><?php echo e(auth()->user()->name); ?></a>
                            </li>
                        <?php else: ?>
                            <li class="nav-item">
        ...
        <footer class="footer bg-dark text-white py-4">
            <div class="top-footer">
                <div class="container">
                    <div class="row">
                        <div class="col-md-4">
                            <img src="<?php echo e(asset('assets/images/my/logo-antrek.png')); ?>"
            ...
            <div class="bottom-footer">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col my-1">
                            <p class="text-white mb-0">© <?php echo e(date('Y')); ?> SMK ANTARTIKA 1 SIDOARJO. Hak Cipta
                                Dilindungi.</p>
                        </div>
...
<?php /**PATH C:\Users\PC_\UKK_BEDOK_PPDB2\resources\views/layouts/landing.blade.php ENDPATH**/ ?>