                ...
                <tr><th>Status Kelulusan</th>
                    <td>
                        ...
                        <?php elseif($siswa->status_kelulusan == 'Tidak Lolos'): ?>
                            ...
                            <?php if($siswa->alasan_penolakan): ?>
                                <div class="alert alert-danger mt-2 mb-0 small">
                                    <strong>Alasan Penolakan:</strong><br>
                                    <?php echo e($siswa->alasan_penolakan); ?>
...
<div class="modal fade" id="modalTolak" tabindex="-1" aria-labelledby="modalTolakLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="<?php echo e(route('admin.calon_siswa.tolak', $siswa->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="modal-body">
                    <div class="alert alert-warning">
                        <strong>Perhatian!</strong> Anda akan menyatakan siswa <strong><?php echo e($siswa->nama_lengkap); ?></strong> TIDAK LOLOS.
                    </div>
                    <div class="mb-3">
                        ...
                        <textarea name="alasan_penolakan" id="alasan_penolakan" class="form-control" rows="4" 
                            ...
                            required minlength="10"><?php echo e(old('alasan_penolakan')); ?></textarea>
...
<?php if($errors->has('alasan_penolakan')): ?>
<script>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\ujian_ppdb1\resources\views/admin/calon_siswa/show.blade.php ENDPATH**/ ?>