...
<?php else: ?>
    <div class="container mt-5">
        <div class="alert alert-warning" role="alert">
            ...
            <a href="<?php echo e(route('siswa.pendaftaran')); ?>" class="btn btn-primary">Isi Pendaftaran</a>
        </div>
    </div>
<?php endif; ?>

<?php /**PATH C:\BEDOK_UKK_PPDB2\resources\views/siswa/dokumen/index.blade.php ENDPATH**/ ?>