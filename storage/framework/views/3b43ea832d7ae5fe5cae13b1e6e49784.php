            ...
            <div class="bank-info-card animate__animated animate__slideInUp" style="animation-delay: 0.2s;">
                ...
                <div class="bank-details" id="bank-details">
                    ...
                    <div class="bank-row">
                        ...
                        <span class="bank-value" id="nominal-display-main">Rp <?php echo e(number_format($siswa->nominal_pembayaran ?? 0, 0, ',', '.')); ?></span>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\ujian_ukk_ppdb\resources\views/siswa/pembayaran/index.blade.php ENDPATH**/ ?>