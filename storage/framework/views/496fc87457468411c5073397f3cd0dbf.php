                ...
                <tr class="text-center table-row-hover">
                    ...
                    <td>
                        <div class="d-flex flex-column gap-1">
                            <a href="<?php echo e(route('admin.calon_siswa.show', $s->id)); ?>" class="btn btn-info btn-sm" style="font-size: 12px; padding: 5px 10px;">
                                🔍 Detail
                            </a>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PC_\UKK_BEDOK_PPDB2\resources\views/admin/calon_siswa/index.blade.php ENDPATH**/ ?>