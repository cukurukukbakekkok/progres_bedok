        ...
        <div class="upload-container">
            ...
            <div class="upload-header animate__animated animate__fadeIn">
                <div class="d-flex justify-content-center mb-3">
                    <a href="<?php echo e(route('siswa.dashboard')); ?>"
                        ...
                        style="background: rgba(255, 255, 255, 0.1); backdrop-filter: blur(5px); border: 1px solid rgba(255, 255, 255, 0.2); transition: all 0.3s ease;">
            ...
            <?php if($dokumen): ?>
                ...
                <div class="status-card animate__animated animate__slideInUp" style="animation-delay: 0.1s;">
                    ...
                    <?php if($dokumen->status_verifikasi == 'Valid'): ?>
                        ...
                        <div class="alert-box alert-success"
                            style="margin: 15px 0 0 0; border: none; background: linear-gradient(135deg, #d4edda 0%, #c3e6cb 100%);">
                    ...
                    <?php elseif($hasUploadedDocuments): ?>
                        ...
                        <div class="alert-box alert-success"
                            style="margin: 15px 0 0 0; border: none; background: linear-gradient(135deg, #fff3cd 0%, #ffeaa7 100%);">
                ...
                <div class="form-card animate__animated animate__slideInUp" style="animation-delay: 0.3s;">
                    <form id="dokumen-form" action="<?php echo e(route('siswa.dokumen.store')); ?>" method="POST"
                        ...
                        <div class="document-item">
                            <h5>
                                ...
                                <?php if($dokumen->foto): ?>
                                    <span
                                        style="margin-left: auto; background: #28a745; color: white; padding: 4px 8px; border-radius: 4px; font-size: 0.75rem; font-weight: 700;">✓
                                        SUDAH DIUPLOAD</span>
                                <?php endif; ?>
                            </h5>
                            <p>Pas foto formal ukuran 3x4 (Latar belakang merah/biru)</p>

                            <div id="foto_upload" style="display: <?php echo e($dokumen->foto ? 'none !important' : 'block'); ?>;">
                            ...
                            <?php if($dokumen->foto): ?>
                                <div class="file-info" style="display: block;">
                                    <span class="file-name">✓ <?php echo e(basename($dokumen->foto)); ?></span>
                                    <div>
                                        <a href="<?php echo e(asset('storage/' . $dokumen->foto)); ?>" target="_blank" class="view-btn">
                                            👁️ Lihat
                                        </a>
                                        <?php if($dokumen->status_verifikasi !== 'Valid'): ?>
                                            <button type="button" class="view-btn" style="background: #ff6b6b; cursor: pointer;"
                                                onclick="document.getElementById('foto_upload').style.display='block'; this.parentElement.parentElement.style.display='none';">
                                                🔄 Ganti
                                            </button>
                                        <?php endif; ?>
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="document-item">
                            ...
                            <div id="akte_kelahiran_upload"
                                style="display: <?php echo e($dokumen->akte_kelahiran ? 'none !important' : 'block'); ?>;">
                                <label class="file-input-label">
                                    📁 Pilih File
                            ...
                            <?php if($dokumen->akte_kelahiran): ?>
                                <div class="file-info" style="display: block;">
                                    ...
                                    <div>
                                        <a href="<?php echo e(asset('storage/' . $dokumen->akte_kelahiran)); ?>" target="_blank"
                                            class="view-btn">
                                            👁️ Lihat
                                        </a>
                                        <?php if($dokumen->status_verifikasi !== 'Valid'): ?>
                                            <button type="button" class="view-btn" style="background: #ff6b6b; cursor: pointer;"
                                                onclick="document.getElementById('akte_kelahiran_upload').style.display='block'; this.parentElement.parentElement.style.display='none';">
                                                🔄 Ganti
                                            </button>
                                        <?php endif; ?>
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="document-item">
                            ...
                            <div id="ijazah_smp_upload"
                                style="display: <?php echo e($dokumen->ijazah_smp ? 'none !important' : 'block'); ?>;">
                                <label class="file-input-label">
                                    📁 Pilih File
                            ...
                            <?php if($dokumen->ijazah_smp): ?>
                                <div class="file-info" style="display: block;">
                                    ...
                                    <div>
                                        ...
                                        <?php if($dokumen->status_verifikasi !== 'Valid'): ?>
                                            <button type="button" class="view-btn" style="background: #ff6b6b; cursor: pointer;"
                                                onclick="document.getElementById('ijazah_smp_upload').style.display='block'; this.parentElement.parentElement.style.display='none';">
                                                🔄 Ganti
                                            </button>
                                        <?php endif; ?>
                                    </div>
                            ...
                            <?php if($dokumen->skl_smp): ?>
                                <div class="file-info" style="display: block;">
                                    ...
                                    <div>
                                        ...
                                        <?php if($dokumen->status_verifikasi !== 'Valid'): ?>
                                            <button type="button" class="view-btn" style="background: #ff6b6b; cursor: pointer;"
                                                onclick="document.getElementById('skl_smp_upload').style.display='block'; this.parentElement.parentElement.style.display='none';">
                                                🔄 Ganti
                                            </button>
                                        <?php endif; ?>
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="document-item">
                            ...
                            <div id="kartu_keluarga_upload"
                                style="display: <?php echo e($dokumen->kartu_keluarga ? 'none !important' : 'block'); ?>;">
                                <label class="file-input-label">
                                    📁 Pilih File
                            ...
                            <?php if($dokumen->kartu_keluarga): ?>
                                <div class="file-info" style="display: block;">
                                    ...
                                    <div>
                                        <a href="<?php echo e(asset('storage/' . $dokumen->kartu_keluarga)); ?>" target="_blank"
                                            class="view-btn">
                                            👁️ Lihat
                                        </a>
                                        <?php if($dokumen->status_verifikasi !== 'Valid'): ?>
                                            <button type="button" class="view-btn" style="background: #ff6b6b; cursor: pointer;"
                                                onclick="document.getElementById('kartu_keluarga_upload').style.display='block'; this.parentElement.parentElement.style.display='none';">
                                                🔄 Ganti
                                            </button>
                                        <?php endif; ?>
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <!-- KTP Orang Tua / Wali -->
                        <?php
                            $isWali = $siswa->status_keluarga != 'ayah_ibu';
                            $labelKtp = $isWali ? 'KTP Wali' : 'KTP Orang Tua';
                            $descKtp = $isWali ? 'Fotokopi KTP wali yang bertanggung jawab' : 'Fotokopi KTP salah satu orang tua';
                        ?>
                        <div class="document-item">
                            <h5>
                                <span>🆔</span>
                            ...
                            <?php if($dokumen->ktp_ortu): ?>
                                <div class="file-info" style="display: block;">
                                    ...
                                    <div>
                                        ...
                                        <?php if($dokumen->status_verifikasi !== 'Valid'): ?>
                                            <button type="button" class="view-btn" style="background: #ff6b6b; cursor: pointer;"
                                                onclick="document.getElementById('ktp_ortu_upload').style.display='block'; this.parentElement.parentElement.style.display='none';">
                                                🔄 Ganti
                                            </button>
                                        <?php endif; ?>
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php if($dokumen->status_verifikasi !== 'Valid'): ?>
                            <div style="display: flex; gap: 15px; justify-content: center; margin-top: 30px;">
                                ...
                                <a href="<?php echo e(route('siswa.dashboard')); ?>" class="btn"
                                    style="background: #6c757d; color: white; padding: 12px 25px; border-radius: 8px; text-decoration: none; font-weight: 600;">
            ...
            <?php else: ?>
                ...
                <div class="status-card">
                    <div class="empty-state">
                        ...
                        <a href="<?php echo e(route('siswa.pendaftaran.create')); ?>"
                            style="display: inline-block; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 12px 24px; border-radius: 10px; text-decoration: none; font-weight: 600; margin-top: 15px;">
                            Lakukan Pendaftaran
                        </a>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\ujian_ppdb1\resources\views/siswa/dokumen/upload.blade.php ENDPATH**/ ?>